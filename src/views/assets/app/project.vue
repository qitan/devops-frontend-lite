  ...
  <page-header-wrapper>
    ...
    <div class="table-page-search-wrapper">
        ...
        <a-row :gutter="48">
            ...
            <a-form-item label="项目标识">
                <a-input v-model="queryParam.projectid" placeholder=""/>
            </a-form-item>
            </a-col>
    ...
    <div class="table-operator">
        ...
        <a-menu slot="overlay" @click="onExtraClick">
            ...
            <!-- lock | unlock -->
            <!-- <a-menu-item v-action="['adminss']" key="2"><a-icon type="lock" />锁定</a-menu-item> -->
        </a-menu>
...
import CreateForm from './modules/ProjectForm'
...
data () {
    ...
    loadData: parameter => {
        ...
        return this.$http.getProjectList(requestParameters)
        .then(res => {
            return res.data
        })
    },
...
methods: {
    ...
    form.validateFields((errors, values) => {
        ...
        if (values.id > 0) {
            // 修改 e.g.
            this.$http.patchProject(values).then(res => {
            this.visible = false
            ...
            // 新增
            this.$http.createProject(values).then(res => {
                this.visible = false
            this.confirmLoading = false
            // 重置表单数据
            form.resetFields()
